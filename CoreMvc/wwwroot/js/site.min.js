$(document).ready(function(){$("#calendario2")!=null&&$("#calendario2").fullCalendar({locale:"pt-br",validRange:{start:"2018-02-01",end:"2018-05-25"},dayClick:function(){var n=$("#calendario2").fullCalendar("getDate");$.ajax("/AtividadesRealizadas/Diario").done(function(n){$("#janelaDiario").append(n);$("#janelaDiario").show()}).fail(function(){alert("Falha!")})}})});
/*!
