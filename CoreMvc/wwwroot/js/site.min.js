function onComplete(){alert("Salvo!")}function abrirJanelaDiario(n,t){$("#janelaDiario .janela .painelTitulo .data").text(n.format("L"));$("#janelaDiario .janela .diario").append(t);$("#janelaDiario").show();$("body").css("overflow","hidden")}function fecharJanelaDiario(){$("#janelaDiario").hide();$("body").css("overflow","auto")}function carregarCalendario(){$("#calendario2").fullCalendar({locale:"pt-br",validRange:{start:"2018-02-01",end:"2018-05-25"},dayClick:function(n){$.ajax("/AtividadesRealizadas/Diario").done(function(t){abrirJanelaDiario(n,t)}).fail(function(){alert("Falha!")})}})}$(document).ready(function(){$("#janelaDiario .fechar").on("click",function(){fecharJanelaDiario()});$("#calendario2")!=null&&carregarCalendario()});
/*!
